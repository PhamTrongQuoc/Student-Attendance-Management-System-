...
class Lesson:
    def __init__(self,root):
        ...
        img3 = PIL.Image.open(r"hinhanh\bgnt.png")
        ...
        #==================================heading====================================
        #====time===
        img_time = PIL.Image.open(r"hinhanh\timsearch50.png")
    ...
    def getNextid(self):
            ...
            my_cursor.execute( # lấy mã buổi học(lesson_id) mới nhất từ bảng buổi học
    ...
    def add_data(self):
        ...
        time_end = datetime.strptime(self.var_timeend.get(), '%H:%M:%S').time()#chuyển txt time_end về dạng thời gian để so sánh
