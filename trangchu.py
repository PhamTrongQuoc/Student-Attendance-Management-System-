...
from hocsinh import Student
#
from nhandangkhuonmat import Face_Recognition
from attendance import Attendance
from nhandangkhuonmat import new_tcid


from baihoc import Lesson
from nhap_csv import InsertData
from baocao_thamdu import Report
...
class Face_Recognition_System(Toplevel):
    def __init__(self, window):
        """takesC window as arguments to show all the attributes and keep let them get advantage of the methods,
        ...
        self.iconbitmap('hinhanh\\222.ico')
        self.resizable(False, False)
        self.admin_dashboard_frame = ImageTk.PhotoImage \
            (file='hinhanh\\home6.jpg')
        ...
        self.txt = "Hệ thống quản lý học sinh trung tâm"
        self.count = 0
        self.text = ''
        ...
        self.heading = Label(self, text=self.txt, font=('times new roman', 20, "bold"), bg="white",
                             ...
                             bd=5,
                             relief=FLAT)
        self.heading.place(x=450, y=26, width=550)
        # self.slider()
        # self.heading_color()
        ...
        # ============================Date and time==============================
        # ========================================================================
        self.clock_image = ImageTk.PhotoImage(file="hinhanh/clock1.png")
        self.date_time_image = Label(self, image=self.clock_image, bg="white")
        self.date_time_image.place(x=29, y=37)
    ...
    def click_home(self):
        ...
        img_ex = PIL.Image.open(r"hinhanh\excel.png")
    ...
    def click_manage(self):
        ...
        # =============Button================
        img_btn1 = Image.open(r"hinhanh\student2.png")
        ...
        img_btn2 = Image.open(r"hinhanh\ghichu.png")
        ...
        img_btn3 = Image.open(r"hinhanh\lesson.png")
        ...
        img_btn4 = Image.open(r"hinhanh\report.png")
    ...
    def click_setting(self):
        ...
        self.setting_dashboard_frame = ImageTk.PhotoImage \
            (file='hinhanh\\setting_frame.png')
