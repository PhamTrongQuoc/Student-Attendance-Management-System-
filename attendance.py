...
class Attendance:
    ...
    def __init__(self,root):
        ...
        today = strftime("%d-%m-%Y")#ngày hôm nay hiện tại
        self.today=strftime("%d-%m-%Y")
        
        self.db=CoSoDuLieu()#thông tin kết nối database
        ...
        #ảnh nền resize
        img3 = PIL.Image.open(r"hinhanh\bgnt.png")#mở ảnh trong thư mục
        ...
        #ảnh thời gian
        img_time = PIL.Image.open(r"hinhanh\timsearch50.png")#mở ảnh
        ...
        # btn_frame
        #ảnh nút đỏ
        img_btn2 = PIL.Image.open(r"hinhanh\btnRed1.png")
        ...
        img_btn1 = PIL.Image.open(r"hinhanh\btnRed1.png")
        ...
        self.AttendanceReportTable.bind("<ButtonRelease>",self.get_cursor)# bắt sự kiện khi click chuột vào bảng dữ liệu
        self.fetch_data()  # load dữ liệu lên bảng grid
        #================fetchData======================
    ...
    def exportCsv(self):
        try:
            ...
            #tạo dataframe có các cột : mã điểm danh,Id học sinh,tên học sinh,....
            ...
            writer = pd.ExcelWriter(
                ...
                'F:\SQLpython\pythonProject\Attendance_CSV\ds__diemdanh_' + str(ts) + '_' + str(
