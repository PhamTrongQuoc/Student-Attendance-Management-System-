...
class Student:
    def __init__(self,root):
        ...
        self.root.iconbitmap('hinhanh\\gaming.ico')
        ...
        self.var_semester = StringVar()#kì học
        ...
        img3 = PIL.Image.open(r"hinhanh\bgnt.png")#Ảnh nền
        ...
        # ==================================heading====================================
        # ====time====
        img_time = PIL.Image.open(r"hinhanh\timsearch50.png")#Ảnh icon thời gian
        ...
        year_combo = ttk.Combobox(current_course_frame,textvariable=self.var_year, font=("times new roman", 11, "normal"), state="readonly",
                                    width=20)
        year_combo["values"] = ("Chọn khóa học", "2023", "2024","2025", "2026")
        ...
        semester_combo = ttk.Combobox(current_course_frame,textvariable=self.var_semester ,font=("times new roman", 11, "normal"), state="readonly",
                                  width=20)
        semester_combo["values"] = ("Chọn học kì", "Kì 1(9-1)", " Kì 2(1-7)", "Kì hè(7-9)")
        ...
        img_btn1 = PIL.Image.open(r"hinhanh\btnRed.png")#ảnh nút màu đỏ
        ...
        #Nút tìm kiếm
        img_btn3 = PIL.Image.open(r"hinhanh\btnRed.png")#ảnh nền màu đỏ
        ...
        #Các nút
        img_btn4 = PIL.Image.open(r"hinhanh\btnRed.png")#ảnh nút màu đỏ
        ...
        img_btn5 = PIL.Image.open(r"hinhanh\btnRed.png")
